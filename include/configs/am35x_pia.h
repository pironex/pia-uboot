...
#define CONFIG_OMAP3_AM35XPIA   1
...
#define CONFIG_SERIAL3              /* UART3 on piA AM35x */
 ...
 * Board NAND Info.
 */
#define CONFIG_SYS_NAND_ADDR        NAND_BASE /* NAND physical address */
#define CONFIG_SYS_NAND_BASE        NAND_BASE /* NAND CS0 physical address */
#define CONFIG_SYS_MAX_NAND_DEVICE  1         /* Max number of NAND devices */
#undef CONFIG_SYS_64BIT_VSPRINTF             /* needed for nand_util.c */
...
/*-----------------------------------------------------
 * ethernet support for piA AM35x
 *------------------------------------------------
 */
