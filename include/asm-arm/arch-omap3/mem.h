...
#if (defined(CONFIG_OMAP3_AM3517EVM) || defined(CONFIG_CRANEBOARD))
...
#else	/* CONFIG_OMAP3_AM3517EVM or CONFIG_CRANEBOARD */
#define M_NAND_GPMC_CONFIG1	0x00001800
...
#endif	/* CONFIG_OMAP3_AM3517EVM or CONFIG_CRANEBOARD */
